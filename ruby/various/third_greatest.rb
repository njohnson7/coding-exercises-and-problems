...
# Using the Ruby language, have the function ThirdGreatest(strArr) take the
...
# letter word in the array. If strArr was ["hello", "world", "after", "all"] the
...
p third_greatest(["hello", "world", "before", "all"]) # wo
p third_greatest(["hello", "world", "after", "all"]) # af
